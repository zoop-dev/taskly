...
const updated = swSrc.replace(/const CACHE = '[^']*'/, `const CACHE = 'taskly-shell-v${version}'`)

writeFileSync(swPath, updated)
console.log(`bump-sw-cache: dist/sw.js cache name set to taskly-shell-v${version}`)
